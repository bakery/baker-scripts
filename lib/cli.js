...
_commander2.default.command('lint <directory> [otherDirectories...]').action(function (directory, otherDirectories) {
  (0, _crossSpawn2.default)(eslint(), ['--config', _path2.default.resolve(__dirname, '../config/.eslintrc'), directory].concat(_toConsumableArray(otherDirectories)), { stdio: 'inherit' });
});
